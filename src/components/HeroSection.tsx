...
//             >
//               {/* Full Stack Web Developer & B.Tech CSE Student */}
//               AI&ML Engineer & B.tech CSE Student
//             </motion.p>
...
export const HeroSection = () => {
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      <div
        className="absolute bottom-1/4 right-1/4 w-[500px] h-[500px] bg-accent/20 rounded-full blur-3xl animate-pulse"
        style={{ animationDelay: "1s" }}
      />
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground/80 max-w-xl mb-10">
          ...
          >
            {/* Outer Glow */}
            <div className="absolute -inset-12 bg-gradient-to-br from-primary/40 via-accent/30 to-primary/30 rounded-3xl blur-3xl opacity-70" />

            {/* Image Container */}
            <div className="relative 
                w-[22rem] h-[28rem] 
                lg:w-[26rem] lg:h-[34rem] 
                xl:w-[30rem] xl:h-[38rem] 
                rounded-3xl 
